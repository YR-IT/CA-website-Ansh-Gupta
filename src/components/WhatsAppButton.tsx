  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <AnimatePresence>
        {(showTooltip || isHovered) && (
          <motion.div
            ...
            className="absolute bottom-full right-0 mb-3 bg-white rounded-lg shadow-lg px-4 py-3 min-w-[200px]"
          >
            <button
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="relative bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300"
